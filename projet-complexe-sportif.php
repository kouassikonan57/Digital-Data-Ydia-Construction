        ...
        <div class="detail-container">
            <div class="detail-grid">
                <div class="detail-content">
                    <h2>Un équipement multifonction</h2>
                    <p>Ce complexe de 15 000 m² regroupe en un seul lieu toutes les infrastructures nécessaires à la pratique sportive de haut niveau comme en loisir.</p>

                    <h3>Infrastructures principales</h3>
                    <ul>
                        <li>Piscine olympique (50m) avec gradins (800 places)</li>
                        <li>Salle omnisports modulable (handball/basket/volley)</li>
                        <li>Dojo et salle d'arts martiaux</li>
                        <li>Espace fitness et wellness (1 200 m²)</li>
                        <li>Mur d'escalade de 12m</li>
                    </ul>

                    <h3>Innovations techniques</h3>
                    <p>Particularités de cette réalisation :</p>
                    <ul>
                        <li>Système de récupération de chaleur des eaux</li>
                        <li>Verrières photovoltaïques</li>
                        <li>Sol amortissant pour les salles de sport</li>
                        <li>Gestion numérique des équipements</li>
                        <li>Matériaux antibactériens pour les espaces humides</li>
                    </ul>

                    <div class="gallery">
                        <img src="https://images.unsplash.com/photo-1547347298-4074fc3086f0?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Piscine olympique">
                        <img src="https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Salle omnisports">
                        <img src="https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Espace wellness">
                    </div>
                </div>
                ...
                <div class="detail-sidebar">
                    <div class="info-box">
                        ...
                        <div class="info-item">
                            ...
                            <span>Type : Équipement sportif</span>
                        </div>
                        <div class="info-item">
                    ...
                    <div class="info-box">
                        <h3>Chiffres techniques</h3>
                        <div class="info-item">
                            <i class="fas fa-tint"></i>
                            <span>Bassin de 3 750 m³ d'eau</span>
                        </div>
                        <div class="info-item">
                            <i class="fas fa-solar-panel"></i>
                            <span>30% d'énergie solaire</span>
                        </div>
                        <div class="info-item">
                            <i class="fas fa-users"></i>
                            <span>Capacité d'accueil : 1 200 personnes</span>
                        </div>
                        <div class="info-item">
                            <i class="fas fa-award"></i>
                            <span>Certification NF Équipements sportifs</span>
                        </div>
                    </div>

                    <a href="index01.php#contact" class="btn" style="width: 100%;">Demander un devis pour un projet similaire</a>
                </div>
            </div>
        </div>
    </section>
