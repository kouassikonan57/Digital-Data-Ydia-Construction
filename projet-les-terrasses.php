        ...
        <div class="detail-container">
            <div class="detail-grid">
                <div class="detail-content">
                    <h2>Concept innovant</h2>
                    <p>Les Terrasses réinventent l'expérience commerciale avec 45 000 m² de surface dédiée au commerce, aux loisirs et à la gastronomie, le tout intégré dans un environnement paysager exceptionnel.</p>

                    <h3>Points forts</h3>
                    <ul>
                        <li>120 enseignes dont 30 nouvelles venues</li>
                        <li>Hypermarket de 8 000 m²</li>
                        <li>Cinéma 12 salles (2 500 places)</li>
                        <li>Toiture végétalisée de 5 000 m²</li>
                        <li>Parking de 2 500 places</li>
                    </ul>

                    <h3>Innovations</h3>
                    <p>Ce projet intègre plusieurs innovations :</p>
                    <ul>
                        <li>Système de géothermie pour le chauffage/rafraîchissement</li>
                        <li>Gestion intelligente des flux visiteurs</li>
                        <li>Toiture végétale avec récupération des eaux pluviales</li>
                        <li>Façades photovoltaïques</li>
                    </ul>
                ...
                <div class="detail-sidebar">
                    <div class="info-box">
                        ...
                        <div class="info-item">
                            ...
                            <span>Type : Centre commercial</span>
                        </div>
                        <div class="info-item">
                    ...
                    <div class="info-box">
                        ...
                        <div class="info-item">
                            ...
                            <span>30% d'économie d'énergie</span>
                        </div>
                        <div class="info-item">
                            <i class="fas fa-tint"></i>
                            <span>Récupération 90% eaux pluviales</span>
                        </div>
                        <div class="info-item">
                            <i class="fas fa-sun"></i>
                            <span>1 200 m² de panneaux solaires</span>
                        </div>
                        <div class="info-item">
                            <i class="fas fa-award"></i>
                            <span>Certification BREEAM Excellent</span>
                        </div>
                    </div>

                    <a href="index01.php#contact" class="btn" style="width: 100%;">Demander une étude commerciale</a>
                </div>
            </div>
        </div>
    </section>
