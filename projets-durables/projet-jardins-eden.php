<?php
$page_title = "YDIA - Les Jardins d'Eden";
        ...
        * {
        ...
        .project-hero {
            ...
            background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)),
                url('assets/projets/jardins-eden/hero.jpg') center/cover;
            display: flex;
            align-items: center;
            color: white;
            text-align: center;
...
<body>
    ...
    <section class="project-hero">
        <div class="container">
            <h1 style="font-size:3.5rem;">Les Jardins d'Eden</h1>
            <p style="font-size:1.5rem;">Éco-quartier certifié HQE Exceptionnel</p>
        </div>
    </section>

    <section class="container" style="padding:80px 20px;">
        <h2 class="section-title text-center">Un nouveau modèle d'habitat durable</h2>

        <div class="eco-grid" style="margin:50px 0;">
            <div class="eco-card">
                <img src="assets/projets/jardins-eden/habitations.jpg" alt="Habitations" style="width:100%; height:200px; object-fit:cover;">
                <div style="padding:20px;">
                    <h3 style="color:<?= $primary_color ?>;">50 logements sociaux</h3>
                    <p>Des habitations bioclimatiques accessibles avec des performances énergétiques exceptionnelles.</p>
                </div>
            </div>

            <div class="eco-card">
                <img src="assets/projets/jardins-eden/espaces-verts.jpg" alt="Espaces verts" style="width:100%; height:200px; object-fit:cover;">
                <div style="padding:20px;">
                    <h3 style="color:<?= $primary_color ?>;">2 hectares d'espaces verts</h3>
                    <p>Jardins partagés, corridors écologiques et zones de biodiversité préservée.</p>
                </div>
            </div>

            <div class="eco-card">
                <img src="assets/projets/jardins-eden/mobilite.jpg" alt="Mobilité" style="width:100%; height:200px; object-fit:cover;">
                <div style="padding:20px;">
                    <h3 style="color:<?= $primary_color ?>;">Mobilité douce</h3>
                    <p>Réseau de pistes cyclables, station de vélos partagés et bornes de recharge.</p>
                </div>
            </div>
        </div>

        <div style="background:#f5f5f5; padding:40px; border-radius:8px; margin:60px 0;">
            <h3 style="text-align:center; margin-bottom:30px; color:<?= $primary_color ?>;">Chiffres clés</h3>
            <div style="display:grid; grid-template-columns:repeat(4, 1fr); text-align:center; gap:20px;">
                <div>
                    <div style="font-size:2.5rem; font-weight:bold; color:<?= $primary_color ?>;">75%</div>
                    <p>Déchets valorisés</p>
                </div>
                <div>
                    <div style="font-size:2.5rem; font-weight:bold; color:<?= $primary_color ?>;">40%</div>
                    <p>Économie d'eau</p>
                </div>
                <div>
                    <div style="font-size:2.5rem; font-weight:bold; color:<?= $primary_color ?>;">200+</div>
                    <p>Arbres plantés</p>
                </div>
                <div>
                    <div style="font-size:2.5rem; font-weight:bold; color:<?= $primary_color ?>;">100%</div>
