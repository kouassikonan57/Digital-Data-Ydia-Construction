        ...
        <div class="detail-container">
            <div class="detail-grid">
                <div class="detail-content">
                    ...
                    <ul>
                        <li>Chambres de 18 à 25 m² avec kitchenette</li>
                        <li>Espaces partagés : cuisines collectives, laverie</li>
                        <li>Bibliothèque collaborative de 300 m²</li>
                        <li>Jardin pédagogique et potager urbain</li>
                        <li>Salles de travail insonorisées</li>
                    </ul>

                    <h3>Innovations durables</h3>
                    <p>Ce projet pionnier intègre :</p>
                    <ul>
                        <li>Matériaux biosourcés (bois, chanvre)</li>
                        <li>Système de récupération des eaux grises</li>
                        <li>Toiture végétalisée avec ruches</li>
                        <li>Capteurs intelligents de consommation</li>
                        <li>Mobiliers en matériaux recyclés</li>
                    </ul>
                ...
                <div class="detail-sidebar">
                    <div class="info-box">
                        ...
                        <div class="info-item">
                            ...
                            <span>Type : Résidence étudiante</span>
                        </div>
                        <div class="info-item">
                    ...
                    <div class="info-box">
                        ...
                        <div class="info-item">
                            ...
                            <span>Bâtiment basse consommation (BBC)</span>
                        </div>
                        <div class="info-item">
                            <i class="fas fa-tint"></i>
                            <span>40% d'économie d'eau</span>
                        </div>
                        <div class="info-item">
                            <i class="fas fa-recycle"></i>
                            <span>85% de matériaux recyclables</span>
                        </div>
                        <div class="info-item">
                            <i class="fas fa-award"></i>
                            <span>Label BiodiverCity</span>
                        </div>
                    </div>

                    <a href="index01.php#contact" class="btn" style="width: 100%;">Demander une visite guidée</a>
                </div>
            </div>
        </div>
    </section>
