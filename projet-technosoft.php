        ...
        <div class="detail-container">
            <div class="detail-grid">
                <div class="detail-content">
                    ...
                    <p>Particularités de ce projet high-tech :</p>
                    <ul>
                        <li>Structure modulaire pour évolutivité</li>
                        <li>Réseau électrique et data redondé</li>
                        <li>Système de climatisation géothermique</li>
                        <li>Façade double peau intelligente</li>
                        <li>Eclairage LED connecté</li>
                    </ul>
                ...
                <div class="detail-sidebar">
                    <div class="info-box">
                        ...
                        <div class="info-item">
                            ...
                            <span>Type : Bureaux high-tech</span>
                        </div>
                        <div class="info-item">
                    ...
                    <div class="info-box">
                        ...
                        <div class="info-item">
                            ...
                            <span>25 km de câbles réseau</span>
                        </div>
                        <div class="info-item">
                            <i class="fas fa-solar-panel"></i>
                            <span>35% d'énergie autonome</span>
                        </div>
                        <div class="info-item">
                            <i class="fas fa-robot"></i>
                            <span>100% domotisé</span>
                        </div>
                        <div class="info-item">
                            <i class="fas fa-mobile-alt"></i>
                            <span>Application de gestion dédiée</span>
                        </div>
                    </div>
