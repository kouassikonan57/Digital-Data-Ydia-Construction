...
$page_title = "YDIA CONSTRUCTION - Réseau d'assainissement Toulouse";
...
<body>
    ...
    <section class="project-hero">
        <div class="project-hero-content">
            <h1>Réseau d'assainissement Toulouse</h1>
            <p>Modernisation complète du réseau d'assainissement du centre-ville historique</p>
        </div>
    </section>
    ...
    <div class="project-detail-container">
        <div class="project-main-content">
            <div class="project-main-text">
                ...
                <p>Le projet de réhabilitation du réseau d'assainissement du centre-ville de Toulouse a représenté un défi technique majeur en raison de la densité urbaine et de la nécessité de préserver le patrimoine historique de la ville rose.</p>

                <p>Nos équipes ont réalisé :</p>
                <ul style="margin: 20px 0; padding-left: 20px;" class="orange-checks">
                    <li style="margin-bottom: 10px;">Pose de 12 km de nouvelles canalisations en matériaux composites haute résistance</li>
                    <li style="margin-bottom: 10px;">Modernisation de 3 stations de pompage avec des technologies éco-responsables</li>
                    <li style="margin-bottom: 10px;">Mise en place d'un système de monitoring intelligent pour la gestion des eaux pluviales</li>
                    <li style="margin-bottom: 10px;">Travaux de voirie associés avec restitution à l'identique des pavés historiques</li>
                </ul>

                <p>Le projet a permis de réduire de 40% les risques d'inondation dans le centre-ville tout en améliorant la qualité du traitement des eaux usées avant rejet dans la Garonne.</p>
                ...
                <div class="project-features">
                    ...
                    <div class="features-grid">
                        <div class="feature-card">
                            ...
                            <p>Système de régulation intelligent pour anticiper les épisodes pluvieux intenses</p>
                        </div>
                        ...
                        <div class="feature-card">
                            ...
                            <p>Utilisation de composites recyclés pour les canalisations (durée de vie 100 ans)</p>
                        </div>
                        ...
                        <div class="feature-card">
                            ...
                            <p>Capteurs IoT pour le suivi en temps réel des flux et de l'état du réseau</p>
                        </div>
                        ...
                        <div class="feature-card">
                            ...
                            <h3>Respect du patrimoine</h3>
                            <p>Techniques non invasives pour préserver le sous-sol historique</p>
                        </div>
                    </div>
                </div>

                <h2 class="section-title" style="margin-top: 60px;">Déroulement du projet</h2>
                <div class="timeline">
                ...
                <div class="project-testimonial">
                    <div class="testimonial-content">
                        ...
                        <div class="testimonial-author">
                            Marie Lambert, Directrice des Services Techniques - Mairie de Toulouse
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="project-sidebar">
                <div class="project-info-card">
                    ...
                    <div class="info-item">
                        <h4>Client</h4>
                        <p>Mairie de Toulouse - Service Assainissement</p>
                    </div>
                    <div class="info-item">
                        <h4>Localisation</h4>
                        <p>Centre-ville de Toulouse, France</p>
                    </div>
                    <div class="info-item">
                        <h4>Date</h4>
        ...
        <div class="project-gallery">
            ...
            <div class="gallery-grid">
                <div class="gallery-item">
                    <img src="https://images.unsplash.com/photo-1605276374104-dee2a0ed3cd6?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Travaux de canalisation">
                </div>
                <div class="gallery-item">
                    <img src="https://images.unsplash.com/photo-1605276374104-dee2a0ed3cd6?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Station de pompage">
                </div>
                <div class="gallery-item">
                    <img src="https://images.unsplash.com/photo-1605276374104-dee2a0ed3cd6?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Techniques de pose">
                </div>
                <div class="gallery-item">
                    <img src="https://images.unsplash.com/photo-1605276374104-dee2a0ed3cd6?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Centre de contrôle">
                </div>
                <div class="gallery-item">
                    <img src="https://images.unsplash.com/photo-1605276374104-dee2a0ed3cd6?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Réfection de voirie">
                </div>
                <div class="gallery-item">
                    <img src="https://images.unsplash.com/photo-1605276374104-dee2a0ed3cd6?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Équipe projet">
                </div>
            </div>
        </div>
