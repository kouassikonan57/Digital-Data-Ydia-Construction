...
$page_title = "YDIA CONSTRUCTION - Réseau d'assainissement";
...
<head>
    ...
    <style>
        ...
        * {
        ...
        .project-hero {
            height: 60vh;
            background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('image/route a14.jpg') no-repeat center center/cover;
            color: <?php echo $secondary_color; ?>;
            display: flex;
            align-items: center;
            margin-top: 80px;
        ...
        .project-hero {
            background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('../image/reseaux-assainissement.jpg') no-repeat center center/cover;
        }
    ...
    <div class="project-detail-container">
        <div class="project-main-content">
            <div class="project-main-text">
                ...
                <p>Le projet de réhabilitation du réseau d'assainissement du centre-ville de Cocody a représenté un défi technique majeur en raison de la densité urbaine et de la nécessité de préserver le patrimoine historique de la ville rose.</p>
        ...
        <div class="project-gallery">
            ...
            <div class="gallery-grid">
                <div class="gallery-item">
                    <img src="../image/reseau d'assainissement.jpg" alt="Travaux de canalisation">
                </div>
                <div class="gallery-item">
                    <img src="../image/resaux-assainissement (1).jpg" alt="Station de pompage">
                </div>
                <div class="gallery-item">
                    <img src="../image/resaux-assainissement (1).png" alt="Techniques de pose">
                </div>
                <div class="gallery-item">
                    <img src="../image/resaux-assainissement (2).jpg" alt="Centre de contrôle">
                </div>
                <div class="gallery-item">
                    <img src="../image/resaux-assainissement (3).jpg" alt="Réfection de voirie">
                </div>
                <div class="gallery-item">
                    <img src="../image/resaux-assainissement (4).jpg" alt="Équipe projet">
                </div>
            </div>
        </div>
