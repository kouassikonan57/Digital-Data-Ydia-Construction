...
$page_title = "YDIA CONSTRUCTION - Voie rapide urbaine San-Pedro";
...
<head>
    ...
    <style>
        ...
        * {
        ...
        .project-hero {
            background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('../image/hero-voie.jpg') no-repeat center center/cover;
        }
...
<body>
    ...
    <section class="project-hero">
        <div class="project-hero-content">
            <h1>Voie rapide urbaine San-Pedro</h1>
    ...
    <div class="project-detail-container">
        <div class="project-main-content">
            <div class="project-main-text">
                ...
                <p>La voie rapide urbaine San-Pedro est un projet d'infrastructure complexe visant à désengorger le trafic dans l'est lyonnais tout en intégrant parfaitement le tissu urbain existant. Sur un linéaire de 8 kilomètres, notre équipe a réalisé :</p>
            ...
            <div class="project-sidebar">
                <div class="project-info-card">
                    ...
                    <div class="info-item">
                        <h4>Client</h4>
                        <p>Métropole de San-Pedro - Direction des Mobilités</p>
                    </div>
                    <div class="info-item">
                        <h4>Localisation</h4>
        ...
        <div class="project-gallery">
            ...
            <div class="gallery-grid">
                <div class="gallery-item">
                    <img src="../image/projet voie (6).jpg" alt="Vue aérienne du tracé">
                </div>
                <div class="gallery-item">
                    <img src="../image/projet voie (2).jpg" alt="Construction d'un échangeur">
                </div>
                <div class="gallery-item">
                    <img src="../image/projet voie (5).jpg" alt="Tunnel en construction">
                </div>
                <div class="gallery-item">
                    <img src="../image/projet voie (7).jpg" alt="Aménagement paysager">
                </div>
                <div class="gallery-item">
                    <img src="../image/projet voie (1).jpg" alt="Pose du revêtement phonique">
                </div>
                <div class="gallery-item">
                    <img src="../image/projet voie (3).jpg" alt="Inauguration officielle">
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            const map = L.map('projectMap').setView([4.75, -6.65], 13); // San-Pédro, Côte d'Ivoire

            L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
                attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
            }).addTo(map);

            // Tracé de la voie rapide (exemple autour de San-Pédro)
            ...
            // Marqueurs mis à jour pour San-Pédro
            const markers = [{
                    coord: [4.760, -6.670],
                    title: "Entrée Nord",
                    description: "Accès depuis la route côtière"
                },
                {
                    coord: [4.750, -6.650],
                    title: "Pont principal",
                    description: "Enjambement de la lagune"
                },
                {
                    coord: [4.745, -6.640],
                    title: "Sortie Sud",
                    description: "Connexion au port de San-Pédro"
                }
            ];
