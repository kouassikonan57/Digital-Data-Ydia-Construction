        ...
        <div class="detail-container">
            <div class="detail-grid">
                <div class="detail-content">
                    ...
                    <ul>
                        <li>Structure : Béton armé avec noyau central</li>
                        <li>Hauteur : 85 mètres</li>
                        <li>Surface totale : 18 500 m²</li>
                        <li>Étages : R+24 + 2 sous-sols</li>
                        <li>Matériaux principaux : Verre, acier et pierre naturelle</li>
                    </ul>

                    <h3>Équipements communs</h3>
                    <p>Le bâtiment propose des espaces partagés exceptionnels :</p>
                    <ul>
                    ...
                    <p>Ce projet situé en zone dense a nécessité des solutions innovantes :</p>
                    <ul>
                        <li>Gestion des nuisances sonores pour le voisinage</li>
                        <li>Optimisation des flux logistiques sur chantier étroit</li>
                        <li>Intégration des normes parasismiques révisées</li>
                        <li>Mise en œuvre d'une façade ventilée haute performance</li>
                    </ul>
                ...
                <div class="detail-sidebar">
                    <div class="info-box">
                        ...
                        <div class="info-item">
                            ...
                            <span>Type : Résidentiel haut de gamme</span>
                        </div>
                        <div class="info-item">
                    ...
                    <div class="info-box">
                        ...
                        <div class="info-item">
                            ...
                            <span>25 mois de chantier</span>
                        </div>
                        <div class="info-item">
                            <i class="fas fa-hard-hat"></i>
                            <span>150 ouvriers en pointe</span>
                        </div>
                        <div class="info-item">
                            <i class="fas fa-truck"></i>
                            <span>8 500 m³ de béton coulés</span>
                        </div>
                        <div class="info-item">
                            <i class="fas fa-bolt"></i>
                            <span>Certification HQE Excellent</span>
                        </div>
                    </div>

                    <a href="index01.php#contact" class="btn" style="width: 100%;">Demander un projet similaire</a>
                </div>
            </div>
        </div>
    </section>
